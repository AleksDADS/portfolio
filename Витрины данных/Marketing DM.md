...
**Данные:**  
Искусственные данные интернет-магазина за период с 2025-06-30 по 2025-07-24.  
...
сколько людей посетило главную страницу; какая средняя конверсия из главной страницы в покупку, а также из показов в клики; какая общая сумма продаж и количество уникальных покупателей; какой средний процент успешно оплаченных корзин от сформированных; товары каких категорий добавляли больше всего. 
...
def etl_inside_clickhouse(**context):
    ...
    client.command("TRUNCATE TABLE tmp.site_visits")
